...
# ---------------------------------------------------------------------------
# CLI entry point: python -m wzrd.video
# ---------------------------------------------------------------------------

def _cli():
    """CLI entry point for ``python -m wzrd.video``."""
    import argparse
    import time
    ...
    parser.add_argument('--threshold', type=int, default=DEFAULT_THRESHOLD,
                        help=f'Difference threshold (default: {DEFAULT_THRESHOLD})')
    parser.add_argument('--boost', type=float, default=DEFAULT_BOOST,
                        help=f'Brightness boost (default: {DEFAULT_BOOST})')
    parser.add_argument('--feather', type=int, default=DEFAULT_FEATHER_RADIUS,
                        help=f'Feather radius (default: {DEFAULT_FEATHER_RADIUS})')
    ...
    def progress(frame_num, total):
        if frame_num % 30 == 0 or frame_num == 1:
            ...
            print(f'  Frame {frame_num}/{total_str}, elapsed: {elapsed:.1f}s', flush=True)
